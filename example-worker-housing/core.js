...
import { spawn_worker } from '../system/extras/worker.js'
...
export const core = (bus) => ({
	run: () => run(bus),
	spawn: () => spawn_worker(new URL('./core.js', import.meta.url), 'run', bus)
})
